--TEST--
UC: Bug #59938 UCIterator fails with large user cache
--SKIPIF--
<?php
...
for(\$i=0;\$i<50000;\$i++) {
    ...
    uc_store('test-niko-asdfasdfasdfkjasdflkasjdfasf'.\$i, \$value);
}

//then later (usually after a few minutes) this won't work correctly:
\$it = new UCIterator('#^test-niko-asdfasdfasdfkjasdflkasjdfasf#');
